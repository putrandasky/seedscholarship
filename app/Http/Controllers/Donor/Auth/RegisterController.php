...
class RegisterController extends Controller
{
    public function choices()
    {
        ...
        $data['degree_level'] = App\DegreeLevel::get();
    ...
    public function newRegister(Request $request)
    {
        ...
        $user->degree_level_id = $request->degree_level;
    ...
    {
        $user = App\Donor::whereHas(
            'donorPeriods', function ($query) use ($request, $userId) {
        ...
        $data = App\DonorPeriod::where([
            ...
            'donor_id' => $userId,
        ])->with('donor.collegeDepartment', 'period')->first();
