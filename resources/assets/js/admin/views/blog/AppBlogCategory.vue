    ...
    <b-card v-show="loaded">
        ...
        <b-row>
            ...
            <b-col xl="3">
                ...
                <b-form-input id="category" v-model="input.category" class="mb-2" placeholder="Category"></b-form-input>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr class="table-primary">
                                ...
                                <th style="width:200px;min-width:200px"><strong>category</strong></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:200px;min-width:200px">
                                            <b-form-input v-model="v.category" size="sm"></b-form-input>
                                        </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateData() {
                this.$store.dispatch('stateLoading', true)
                axios.patch(`api/blog-category/${this.confirmModalTempValue.id}`, {
            ...
            deleteData() {
                ...
                this.$store.dispatch('stateLoading', true)
                axios.delete(
                        `api/blog-category/${this.confirmModalTempValue}`)
                    .then((response) => {
                        console.log(response.data)
                        this.getData()
                        this.confirmModalTempValue = ''
