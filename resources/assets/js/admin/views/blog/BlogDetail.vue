  ...
  <b-row v-show="loaded" class="d-flex">
    <b-col md="9" >
      <b-card >
        ...
        <b-form-group
          label="Summary (Required for Meta Tags)"
          label-for="title"
        ...
        >
          <b-form-input
            ...
            id="summary"
            type="text"
            placeholder="Input summary of your post"
            v-model="data.summary"
          ></b-form-input>
        </b-form-group>
        <b-form-group  ref="containerLoading"
    ...
    <b-col md="3" class="">
      <b-card>
        ...
        <div slot="footer" v-if="publishingPermition">
          <div class="text-center">
            ...
            <b-button
              variant="secondary"
              @click="handlePublishButton('DRAFT')"
              size="sm"
              >Save as Draft</b-button
            >
            <b-button
              variant="primary"
              @click="handlePublishButton('PUBLISH')"
              size="sm"
              >Publish</b-button
            >
          </div>
      ...
      <b-card>
        ...
        <b-form-group
          :invalid-feedback="errors.blog_category_id"
          :state="stateCategory"
        >
          <b-form-select
            plain
      ...
      <b-card no-body>
        ...
        <b-btn
          v-show="data.cover_image || new_cover_image"
          class="btn--corner"
          variant="danger"
          size="sm"
          style="top:47px"
        ...
        <b-btn
          v-show="old_cover_image && new_cover_image"
          class="btn--corner"
          variant="warning"
          size="sm"
    ...
    <b-modal
      title="Leave Moderation Message"
      v-model="moderationModal"
      @ok="
        trigerConfirmModal(
