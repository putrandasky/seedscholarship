    ...
    <b-col md="3" class=" order-1 order-md-2">
      <b-card>
        ...
        <div class="text-center">
          <b-button variant="secondary" @click="postData('DRAFT')"
            >Save as Draft</b-button
          >
          <b-button  v-if="permission(16)" variant="primary" @click="postData('PUBLISH')"
            >Publish</b-button
          >
        </div>
      </b-card>
      ...
      <b-card>
        ...
        >
          <b-form-select
            plain
            v-model="input.blog_category_id"
