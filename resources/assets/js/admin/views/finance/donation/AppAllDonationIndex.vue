  ...
  <slide-y-up-transition>
    <div v-show="loaded">
        ...
        >
          <template v-slot:head(created_at)="data">
            ...
            <i
              ...
              title="Tanggal submit/penerimaan konfirmasi donasi"
          ...
          <template v-slot:head(trx_date)="data">
            ...
            <i
              v-b-tooltip.top.hover
              title="Tanggal actual transaksi"
              class="fa fa-info-circle"
              style="cursor: pointer"
            ></i>
          </template>
          ...
          <template v-slot:head(verification)="data">
            ...
            <i
              v-b-tooltip.top.hover
              title="Status verifikasi transaksi"
              class="fa fa-info-circle"
              style="cursor: pointer"
            ></i>
          </template>
          <template v-slot:head(invoice_no)="data">
            ...
            <i
              v-b-tooltip.top.hover
              title="Nomor invoice dan bukti penerimaan donasi"
              class="fa fa-info-circle"
              style="cursor: pointer"
            ></i>
          </template>
          <template v-slot:head(status_invoice)="data">
            ...
            <i
              v-b-tooltip.top.hover
              title="Untuk menginformasikan status bukti penerimaan donasi sudah terkirim ke donatur atau belum"
              class="fa fa-info-circle"
              style="cursor: pointer"
            ></i>
          </template>
          ...
          <template v-slot:cell(evidence)="data">
            <evidence
              :propsFileName="data.item.evidence"
              :propsDataId="data.item.id"
              :propsIndex="data.index"
              :propsUserId="data.item.donor.id"
            />
          </template>
          ...
          <template v-slot:cell(invoice_no)="data">
            <invoice
              :invoiceNo="data.item.invoice_no"
              :dataId="data.item.id"
              :index="data.index"
              :hasInvoice="data.item.has_invoice"
              :userId="data.item.donor.id"
          ...
          <template v-slot:cell(actions)="data">
            <b-btn-group>
              ...
              <b-btn
                ...
                variant="success"
                size="sm"
                v-b-tooltip.hover="'Send Payment Receipt'"
                @click="
                  triggerConfirmModal(
      ...
      >
        ...
        <b-form-group
          v-if="transactionModalState == 'editTransaction'"
          :invalid-feedback="errors.verification"
        ...
        <b-form-group
          v-if="transactionModalState == 'editTransaction'"
          :invalid-feedback="errors.invoice_no"
        ...
        >
          <b-input-group>
            ...
            <b-input
              ...
              "
              class="form-control"
              placeholder="Invoice Number (If Ready)"
              v-model="input.invoice_no"
              :state="stateInvoiceNumber"
            />
          </b-input-group>
        </b-form-group>
