  ...
  <b-col md="3" sm="6" class="pb-3">
    <div class="border-bottom">
      <h5><i class="fa fa-briefcase"></i> Collection Officer
        <b-button  v-if="permission(12)" class="btn--corner-15 btn--xs" size="sm" variant="success" @click="editPcoModal = true"
    ...
    <b-modal  v-if="permission(12)" :ok-disabled="checkOkEditPco" :no-close-on-esc="true" :hide-header-close="true"
