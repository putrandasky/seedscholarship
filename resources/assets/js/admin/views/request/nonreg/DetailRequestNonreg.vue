  ...
  <slide-y-up-transition>
    <b-row v-show="loaded">
        ...
        <b-card>
          ...
          <b-row>
            ...
            <b-col md="3" sm="6"  class="pb-3">
              ...
              <span style="font-size:large;padding-left:20px">{{data.awardee_nonreg_scholarships[0].status}}</span>
            </b-col>
            <b-col md="3" sm="6"  class="pb-3">
              <div class="border-bottom">
      ...
      <b-col cols="12">
        <b-row>
          <b-col lg="3" sm="6">
            <file-card title="Curriculum Vitae" :scholarshipId="data.awardee_nonreg_scholarships[0].scholarship_id" :registrationCode="data.awardee_nonreg_scholarships[0].registration_code"
              folder="cv" :data="files.cv" />
          </b-col>
          <b-col lg="3" sm="6">
            <file-card title="Proposal" folder="proposal" :scholarshipId="data.awardee_nonreg_scholarships[0].scholarship_id" :registrationCode="data.awardee_nonreg_scholarships[0].registration_code"
              :data="files.proposal" />
          </b-col>
          <b-col lg="3" sm="6">
            <file-card title="Surat Keterangan" folder="sktmb" :scholarshipId="data.awardee_nonreg_scholarships[0].scholarship_id" :registrationCode="data.awardee_nonreg_scholarships[0].registration_code"
              :data="files.sktmb" />
          </b-col>
          <b-col lg="3" sm="6">
            <file-card title="SiakNG" folder="siakng" :scholarshipId="data.awardee_nonreg_scholarships[0].scholarship_id" :registrationCode="data.awardee_nonreg_scholarships[0].registration_code"
              :data="files.siakng" />
          </b-col>
        </b-row>
      </b-col>
