<template>
  ...
  <b-row v-show="loaded">
    ...
    <b-col cols="12">
      <b-row>
        <b-col lg="3" sm="6">
          <file-card title="Curriculum Vitae" :periodId="data.scholarships[0].id" :registrationCode="data.scholarships[0].pivot.registration_code"
            folder="cv" :data="files.cv" />
        </b-col>
        <b-col lg="3" sm="6">
          <file-card title="Proposal" folder="proposal" :periodId="data.scholarships[0].id" :registrationCode="data.scholarships[0].pivot.registration_code"
            :data="files.essay" />
        </b-col>
        <b-col lg="3" sm="6">
          <file-card title="Surat Keterangan"  folder="sktmb"  :periodId="data.scholarships[0].id" :registrationCode="data.scholarships[0].pivot.registration_code"
           :data="files.slip" />
        </b-col>
        <b-col lg="3" sm="6">
          <file-card title="SiakNG" folder="siakng" :periodId="data.scholarships[0].id" :registrationCode="data.scholarships[0].pivot.registration_code"
            :data="files.siakng" />
        </b-col>
      </b-row>
    </b-col>
