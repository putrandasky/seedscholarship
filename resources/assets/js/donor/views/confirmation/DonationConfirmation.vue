      ...
      <b-row class="justify-content-center">
        ...
        <b-col sm="8" v-if="confirmationFormSent">
          ...
          <div class="text-center">
            <i
              class="fa fa-heart display-1"
              id="checkmark"
              style="color:red"
            ></i>
            <p>
              Terima kasih telah melakukan donasi untuk SEED Scholarship. Tim
              kami akan melakukan verifikasi dan segera mengirimkan bukti
              penerimaan donasi.
            </p>
          </div>
        </b-col>
        <b-col md="8" lg="6" v-if="authorized && !confirmationFormSent">
          <b-card no-body class="mx-4">
            <form
              class="card-body p-4"
              @submit.prevent="sendConfirmationForm"
              autocomplete="off"
            >
              ...
              <b-row class="form-group">
                <b-col lg="6">
                  <b-form-group
                    :invalid-feedback="errors.trx_date"
                    :state="stateTrxDate"
                  >
                    <b-input-group>
                ...
                <b-col lg="6">
                  <b-form-group
                    :invalid-feedback="errors.amount"
                    :state="stateAmount"
                  >
                    <b-input-group class="">
                      <b-input-group-prepend>
                ...
                <b-col lg="12">
                  <b-form-group
                    ...
                    :state="stateFile"
                    description="File jpeg/png/pdf (max: 1MB)"
                  >
                    <b-form-file
...
export default {
  ...
  computed: {
    ...
    stateFile() {
      return this.errors.file == 'no-error'
        ? true
        : this.errors.file
        ? false
        : null;
  ...
  methods: {
    ...
    sendConfirmationForm() {
      ...
      axios
        .post(`api/donor-transaction/confirmation`, formData, {
          params: {
