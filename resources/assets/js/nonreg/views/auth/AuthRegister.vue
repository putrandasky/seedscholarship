          ...
          <b-card no-body class="mx-4">
            ...
            >
              ...
              <b-row class="form-group">
                      ...
                      >
                        <template slot="first">
                          <option :value="null" disabled
                            >-- Please select your field of study --</option
                          >
                        </template>
                      </b-form-select>
                    </b-input-group>
                ...
                <b-col sm="12">
                  <b-form-group
                    :invalid-feedback="errors.scholarship_id"
                  ...
                  >
                    <b-input-group class="">
                      ...
                      <b-form-select
                        ...
                        v-model="input.scholarship_id"
                        :state="stateScholarship"
                      >
                        <template slot="first">
                          <option :value="null" disabled
                            >-- Please select program --</option
                          >
                        </template>
                      </b-form-select>
                    </b-input-group>
              ...
              <b-button
                ...
                variant="success"
                block
                ><i v-show="isDisabled" class="fa fa-spinner fa-spin"></i>
                Submit</b-button
              >
            </form>
          </b-card>
...
export default {
  ...
  computed: {
    ...
    loaded() {
      return this.scholarshipOptions.length>0 && this.departmentOptions.length>0 ? true : false;
    },
    stateName() {
    ...
    stateScholarship() {
      return this.errors.scholarship_id == 'no-error'
        ? true
        : this.errors.scholarship_id
        ? false
        : null;
    },
    stateYear() {
  ...
  methods: {
    checkOpenRegistration() {
      axios
        .get(`api/common/open-registration/scholarship`)
        .then(response => {
    ...
    register() {
      ...
      axios
        .post('api/auth/nonreg/register', this.input)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.errors.scholarship_id = errors.scholarship_id
            ? errors.scholarship_id[0]
            : 'no-error';
