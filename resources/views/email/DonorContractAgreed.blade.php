...
Donatur <strong>{{$data->donorPeriods[0]->donation_category}}</strong> periode SEED Scholarship
<strong>#{{$data->donorPeriods[0]->period->period}}</strong> untuk tahun
<strong>{{$data->donorPeriods[0]->period->year}}</strong>
@endcomponent
