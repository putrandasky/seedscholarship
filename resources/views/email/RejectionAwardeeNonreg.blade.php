...
Hai <strong>{{$data->awardee_nonreg->name}}</strong>,

Terima kasih atas ketertarikan Kamu pada Beasiswa SEED Scholarship <b> #{{$data->scholarship->name}}</b> tahun <b>{{$data->scholarship->year}}</b>.
Kami menerima banyak Mahasiswa/i yang memenuhi syarat dan hal ini merupakan keputusan yang sulit. Dengan menyesal Kami menginformasikan Kamu belum terpilih menjadi Awardee SEED Scholarship <b> #{{$data->scholarship->name}}</b> tahun <b>{{$data->scholarship->year}}</b>.
