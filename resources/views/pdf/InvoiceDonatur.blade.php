    ...
    <table class="table table-bordered p-1">
      <tbody>
        <tr>
          ...
          <td style="padding-left:30px;font-weight:bold">{{Carbon\Carbon::parse($donor->donorTransactions[0]->trx_date)->format('d F Y')}}</td>
        </tr>
        <tr>
          <td style="width:250px">Jumlah Donasi</td>
          <td style="padding-left:30px;font-weight:bold">Rp {{number_format($donor->donorTransactions[0]->amount,0,",",".")}},- ({{ucwords(terbilang($donor->donorTransactions[0]->amount))}} Rupiah)</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div>
    <table style="width:200px">
      <tbody>
        ...
        <tr>
          <td class="text-center">Qi Yahya</td>
        </tr>
      </tbody>
    </table>
  </div>
  <br>
  <small class="italic" style="color:grey">We exist to lighten and motivate students to reach the excellence in education</small>
</body>
