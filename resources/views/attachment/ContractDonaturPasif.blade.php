...
<body style="margin:30px 60px">
  ...
  <div>
    ...
    <div class="text-center font-14">Nomor: {{$series}}/SEEDS/DP/{{$data->periods[0]->year}}</div>
    <br />
...
<table style="border-spacing:0px">
    ...
    <div class="text-justify" style="text-indent:35px">
      Donatur Pasif membayarkan donasi minimal satu kali dalam periode 12 bulan terhitung dari Januari {{$data->periods[0]->year}} hingga Desember {{$data->periods[0]->year}}.
    </div>
    <br/>
